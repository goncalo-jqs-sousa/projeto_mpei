...
for i = 1 : n_vezes
    ...
    % NB_test_func(Data,Cat,Cat(1),400,200,true,'ateste_noDesc_400x200_music.txt',n_max_word, true);

    % NB_test_func(Data,Cat,Cat(2),400,200,true,'ateste_noDesc_400x200_news.txt',n_max_word, true);
